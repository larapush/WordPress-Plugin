...
class Unlimited_Push_Notifications_By_Larapush {
	...
	private function load_dependencies() {
		 ...
		 * core plugin.
		 */
		require_once plugin_dir_path( dirname( __FILE__ ) ) . 'includes/class-unlimited-push-notifications-by-larapush-loader.php';

		/**
		 * The class responsible for defining internationalization functionality
		 * of the plugin.
		 */
		require_once plugin_dir_path( dirname( __FILE__ ) ) . 'includes/class-unlimited-push-notifications-by-larapush-i18n.php';

		/**
		 * The class responsible for helper functions required for admin and side of the site.
		 */
		require_once plugin_dir_path( dirname( __FILE__ ) ) . 'admin/class-unlimited-push-notifications-by-larapush-admin-helper.php';

		/**
		 * The class responsible for defining all actions that occur in the admin area.
		 */
		require_once plugin_dir_path( dirname( __FILE__ ) ) . 'admin/class-unlimited-push-notifications-by-larapush-admin.php';

		/**
		 * The class responsible for defining all actions that occur in the public-facing
		 * side of the site.
		 */
		require_once plugin_dir_path( dirname( __FILE__ ) ) . 'public/class-unlimited-push-notifications-by-larapush-public.php';
	...
	private function define_admin_hooks() {
		...
		$plugin_admin = new Unlimited_Push_Notifications_By_Larapush_Admin( $this->get_plugin_name(), $this->get_version() );
